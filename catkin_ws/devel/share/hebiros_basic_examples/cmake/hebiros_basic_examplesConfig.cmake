...
if("TRUE" STREQUAL "TRUE")
  set(hebiros_basic_examples_SOURCE_PREFIX /home/robot/catkin_ws/src/hebiros/hebiros_basic_examples)
  set(hebiros_basic_examples_DEVEL_PREFIX /home/robot/catkin_ws/devel)
  ...
  set(hebiros_basic_examples_INSTALL_PREFIX /home/robot/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hebiros_basic_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/hebiros/hebiros_basic_examples/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hebiros_basic_examples_NUM_DUMMY_TARGETS)
      set(hebiros_basic_examples_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hebiros_basic_examples::wrapped-linker-option${hebiros_basic_examples_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hebiros_basic_examples_NUM_DUMMY_TARGETS "${hebiros_basic_examples_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hebiros_basic_examples::wrapped-linker-option${hebiros_basic_examples_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hebiros_basic_examples_LIBRARIES "${interface_target_name}")
